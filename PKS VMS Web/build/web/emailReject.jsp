...
<div class="w3-main" style="margin-left:360px; margin-top:43px;">
  ...
  <section>
    ...
    <center><h1>Sending Reject E-mail</h1></center>
        <%!
         public static class SMTPAuthenticator extends Authenticator {
            ...
            if(request.getParameter("send") != null) {
                ...
                %>
        <form name="myForm" action="emailReject.jsp" method="POST">
            <center>
            <table border="0">
...
<%
        try {
             ...
             %> 
                ...
                <tr>
                     <td><b>To: </td>
                    <td><b><b><input value="<%=rs.getString("Email")%>"  type="text" name="to" value="" size="32" required/><br/></td>
                </tr>
...
%>     
                ...
                <tr>
                    ...
                    <td><input type="text" name="subject" value="Appointment had been rejected" size="38" required/><br><br></td>
                </tr>
                
                <tr>
                    <td><b>Message : <br><br></td>
                    <td><textarea rows="15" cols="70" name="message" required/>Dear sir / madam, we are sorry that your appointment was rejected on dd/mm/yyyy based on your current condition. For further details, you can contact 082-845 596.</textarea><br></td>
                </tr>
                
                </table>
                
                <input type="hidden" name="hidden" value="<%= result %>">
                <input type="submit" name="send" style="height:35px;width:100px;" value="Send">&nbsp; &nbsp; &nbsp;
                <input type="reset" name="reset" style="height:35px;width:100px;" value="Reset">&nbsp; &nbsp; &nbsp;
