...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:200px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#appointment" class="w3-bar-item w3-button w3-padding">Appointment List</a>
...
<%
 try {
    ...
    <td><%=rs.getString("Travel")%></td>
    <td><%=rs.getString("Countries")%></td>
    <td><%=rs.getString("Status")%></td>
    <td><input type="button" name="approved" value="Approve"  style="height:30px;width:70px;" onClick="window.location='emailApprove.jsp?appointmentid=<%=rs.getString("Appointment_ID") %> '" class="button"><br>
        <input type="button" name="rejected" value="Reject"  style="height:30px;width:70px;" onClick="window.location='emailReject.jsp?appointmentid=<%=rs.getString("Appointment_ID") %> '" class="button"><br>
        <input type="button" name="edit" value="Edit"  style="height:30px;width:70px;" onClick="window.location='updateAppointment.jsp?appointmentid=<%=rs.getString("Appointment_ID") %>'" class="button"><br>
   </td>
    </tr>
