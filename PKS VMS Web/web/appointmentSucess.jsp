        ...
        <div class="row">
	   	...
	   	<nav id="main-nav-wrap">
				<ul class="main-navigation">
					...
					<li><a href="visitorAppointment.jsp">APPOINTMENT</a></li>
   	...
   	<div class="intro-content">
   		<div class="row">
   			...
   			<div class="col-twelve">
	   			...
	   			<h5>Your appointment request has been sent! Please wait our reply :)</h5>
                                <h5>Click <a href='index.jsp'>here</a> go to main page.</h5> 
